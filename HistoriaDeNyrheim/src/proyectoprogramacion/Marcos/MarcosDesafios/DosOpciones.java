...
public class DosOpciones extends javax.swing.JFrame {

    private Aldea aldea;

    public DosOpciones(Aldea aldea) {
        this.aldea = aldea;
        initComponents();
    }
    ...
    public void cajaTexto2Opciones(int numTexto) { // Pasas un numero de texto por parámetro y lo imprime en la caja de textos
        cajaTexto.setText(TextoEImagenes.cargaTexto(numTexto));
    }

    public void cajaTexto2Opciones2(String texto) { // Pasas un texto por parámetro y lo imprime en la caja de textos
